...
const heroBg = () => {
  return (
    <div className='absolute top-20 left-0 w-full h-full' >
      <div className=" heroCircleCon c1 absolute  bottom-2 left-1/2 -translate-x-1/2 w-[55%] aspect-square rounded-full  blur-xs opacity-50 ring-1 ring-[#f2c204] flex justify-center items-center  ">

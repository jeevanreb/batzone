  ...
  return (
    <>
      <div
        ...
        className={`flex w-full justify-center ${fullRelative ? "" : `p-5 lg:px-10 ${!header && "lg:py-10"}`} ${center ? (tabCenter ? "md:h-screen md:items-center" : "lg:h-screen lg:items-center") : ""} ${className}`}
      >
        <div
